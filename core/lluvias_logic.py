...
def analizar_eventos_lluvia(df_filtrado, station_id=""):
    ...
    try:
        ...
        with plt.style.context('default'):
            ...
            t_series = f'Serie de Valores Máximos Anuales - {station_id}' if station_id else 'Serie de Valores Máximos Anuales'
            ax_series.set_title(t_series, fontweight='bold')
        ...
        with plt.style.context('default'):
            ...
            t_acf = f'Correlograma (ACF) - {station_id}' if station_id else 'Correlograma (ACF)'
            ax_acf.set_title(t_acf, fontweight='bold')
        ...
        with plt.style.context('default'):
            ...
            t_wei = f'Posición de Graficación (Weibull) - {station_id}' if station_id else 'Posición de Graficación (Weibull)'
            ax_wei.set_title(t_wei, fontweight='bold')
        ...
        with plt.style.context('default'):
            ...
            t_dist = f'Comparación de Distribuciones de Probabilidad - {station_id}' if station_id else 'Comparación de Distribuciones de Probabilidad'
            ax_dist.set_title(t_dist, fontweight='bold')
